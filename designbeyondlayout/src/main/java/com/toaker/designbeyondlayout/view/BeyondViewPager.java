 ...
 *******************************************************************************/
package com.toaker.designbeyondlayout.view;
 ...
 * @Time Create by 2015/5/13 17:11
 */
public class BeyondViewPager extends ViewGroup {

    private static final String TAG = "BeyondViewPager";
    private static final boolean DEBUG = false;

    private static final boolean USE_CACHE = false;

    /** The number of steps of pre-loaded viewPager, If 0 means no preload */
    private int DEFAULT_OFFSCREEN_PAGES = 0;

    private int MAX_SETTLE_DURATION = 600;
    ...
    public BeyondViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public BeyondViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
    ...
    public void setOffscreenPages(int offscreenPages){
        this.DEFAULT_OFFSCREEN_PAGES = offscreenPages;
    }

    public void setMaxSettleDuration(int duration){
        this.MAX_SETTLE_DURATION = duration;
    }
